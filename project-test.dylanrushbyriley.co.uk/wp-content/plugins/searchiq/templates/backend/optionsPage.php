...
$custom_search_page			= $settings['custom_search_page'];
...
$siq_custom_search_page = $settings['custom_search_page'];
$siq_invalid_custom_search_page = true;
	...
	<form method="POST" action="<?php echo admin_url( 'admin.php?page=dwsearch&tab=tab-2'); ?>" class="custom_page_options" name="custom_options" onSubmit="return checkSiqOptions();">
		<div class="section section-1">
			...
			<div class="data pageList">
				...
				<select id="siq_custom_search_page" name="siq_custom_search_page">
					<option value="" >--Select Page--</option>
					<?php foreach($pages as $page){ ?>
						<option value="<?php echo $page->ID;?>"
							<?php if(isset($custom_search_page)&& $custom_search_page==$page->ID){
			...
			<?php if($this->licensed && $this->allowHideLogo){ ?>
				<div class="data">
